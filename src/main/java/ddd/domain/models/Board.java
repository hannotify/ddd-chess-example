...
public record Board(Map<Square, Piece> piecesOnSquare) implements ValueObject {
    ...
    public static Board make(Move move, Board board) throws IllegalChessMoveException {
