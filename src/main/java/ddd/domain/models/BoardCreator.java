...
public class BoardCreator {
    ...
    public static Board singlePawnBoard() {
    ...
    private static Map<Square, Piece> placePieces(Rank rank, ChessColor chessColor) {
        ...
        boardMap.put(new Square(File.d, rank), new Queen(chessColor));
        boardMap.put(new Square(File.e, rank), new King(chessColor));
        boardMap.put(new Square(File.f, rank), new Bishop(chessColor));
        boardMap.put(new Square(File.g, rank), new Knight(chessColor));
        boardMap.put(new Square(File.h, rank), new Rook(chessColor));
        return boardMap;
    }
